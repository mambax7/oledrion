...
<div id="xo-print">
    ...
    <div id="print-info">
        ...
        <div class="pad2"><span class="bold"><{$smarty.const._DATE}></span>
            : <{if $order.cmd_create > 0 }><{$order.cmd_create_date}><{else}><{$order.cmd_date|date_format:"%d/%m/%Y"}><{/if}>
        </div>
        <div class="pad2"><span class="bold"><{$smarty.const._OLEDRION_FIRSTNAME}></span>
            : <{$order.cmd_firstname}> <{$order.cmd_lastname}></div>
        ...
        <table class="center" width="90%">
            ...
            <{foreach item=product from=$products}>
                <tr>
                    ...
                    <td class="center"
                    <div class="oledrion_productprice"><{$product.product_caddy.caddy_qte}></div>
                    </td>
                    <td class="center">
                        <div class="oledrion_productprice"><{$product.product_caddy.caddy_price_fordisplay}></div>
                    </td>
                                ...
                                <{foreach item=attribute from=$product.product_attributes}>
                                    <li><{$attribute.attribute_title}>
                                        <{foreach item=option from=$attribute.attribute_options}>
                                            <div class="attribute_options"><{$option.ca_attribute_name}>
                                                : <{$option.ca_attribute_price_formated}></div>
                                        <{/foreach}>
                                    </li>
                                <{/foreach}>
                            </ul>
            ...
            <tr class="center">
                <td class="center">
                    <h3><{$smarty.const._OLEDRION_TOTAL}><h3>
                </td>
                <td class="center">&nbsp;</td>
                <td class="center">
                    <div class="oledrion_productprice"><{$order.cmd_total_fordisplay}></td>
